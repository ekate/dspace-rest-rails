...
Note: The root of the app takes ~7s to load because of an external dspace SQL query issue and is not because of the app itself. (I may add caching for performance in the future)
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
**To contribute:**
